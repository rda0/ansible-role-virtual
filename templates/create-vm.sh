...
dd if=/dev/r10/vm-template of=/dev/{{ vg }}/{{ guest_name }}-root bs=1M
...
--boot=kernel=/vmlinuz,initrd=/initrd.img,kernel_args="root=/dev/sda elevator=noop console=ttyS0,115200n8 serial" \
{% if mac is defined %}
